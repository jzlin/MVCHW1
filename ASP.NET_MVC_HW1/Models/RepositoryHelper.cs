namespace ASP.NET_MVC_HW1.Models
{
	public static class RepositoryHelper
	{
		...
		public static SimpleReportRepository GetSimpleReportRepository()
		{
			var repository = new SimpleReportRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static SimpleReportRepository GetSimpleReportRepository(IUnitOfWork unitOfWork)
		{
			var repository = new SimpleReportRepository();
